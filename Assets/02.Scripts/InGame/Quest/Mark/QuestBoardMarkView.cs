...
public class QuestBoardMarkView : MonoBehaviour
{
    [Header("참조 컴포넌트")]
    ...
    private void Awake()
    {
        ...
        if (_questBoard != null && _boardData == null)
        {
            _boardData = _questBoard.BoardQuest;
        }
    }
    ...
    public void Refresh()
    {
        if (_questMarkService == null || _worldMarkView == null || _boardData == null)
        {
        ...
        EWorldMarkVisualType visualType = _questMarkService.GetQuestBoardMarkVisualType(_boardData);
