// =============================================================================
// Custom/OcclusionDither
// =============================================================================
// URP Lit 기반 + 오클루전 디더 기능 추가.
// 카메라-플레이어 사이 가림 오브젝트에 사용.
// PlayerOcclusionAbility가 MaterialPropertyBlock으로
// _OcclusionScreenPos, _OcclusionRadius 를 동적으로 설정하면
// 플레이어 스크린 좌표 기준 원형 영역만 디더 클립된다.
// =============================================================================
Shader "Custom/OcclusionDither"
{
    Properties
    {
        // ── URP Lit 표준 프로퍼티 ──
    ...
    SubShader
    {
        ...
        // ============================================================
        // Pass 0: ForwardLit (URP Lit + 오클루전 디더)
        // ============================================================
        Pass
        {
            Name "ForwardLit"
            ...
            #pragma fragment OcclusionDitherLitFrag
